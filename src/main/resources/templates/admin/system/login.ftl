  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href=""> <img alt="light year admin" src="/admin/images/logo.png" width="200px" height="38px"><span style="height: 40px;line-height: 40px;size:15px;">二手市场后台</span></a>
      </div>
      <form id="login-form" method="post">
        ...
        <div class="form-group">
          <button class="btn btn-block btn-cyan" type="button" id="submit-btn">立即登录</button>
        </div>
      </form>
      <hr>
